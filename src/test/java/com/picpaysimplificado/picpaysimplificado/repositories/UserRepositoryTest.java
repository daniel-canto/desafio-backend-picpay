...
@DataJpaTest
// Usado para utilizar a propertie de teste
@ActiveProfiles("test")
class UserRepositoryTest {
    ...
    void findUserByDocumentCase1() {
        ...
        UserDTO data = new UserDTO("Daniel", "Canto", document,
                new BigDecimal(10), "daniel@teste.com", "senha123", UserType.COMMON);
